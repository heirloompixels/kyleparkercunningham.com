...
<!--kg-card-end: markdown--><h3 id="pescia">Pescia</h3><p>My favorite paper.</p>{{ art_image(path="paper/pescia.jpeg") }}<h3 id="rives-bfk"><a href="https://www.takachpaper.com/product/rives-bfk-paper/">Rives BFK</a></h3><p></p><h3 id="german-etching">German Etching<br></h3>{{ art_image(path="paper/german-etching.jpeg") }}<h3 id="hahnemuhle-papers-copperplate"><a href="https://www.takachpaper.com/product/hahnemuhle-papers-copperplate/">Hahnemuhle Papers Copperplate</a></h3><p></p><h3 id="pescia-1">Pescia</h3><!--kg-card-begin: markdown--><ul>
<li>Has two distinct sides</li>
</ul>
<!--kg-card-end: markdown--><p></p><h3 id="somerset">Somerset</h3>{{ art_image(path="paper/somerset.jpeg") }}<h3 id="stonehenge">Stonehenge</h3>{{ art_image(path="paper/IMG_1216.jpeg") }}